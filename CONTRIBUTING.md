...
2. Name the file `/art/[your_username]/[artname].html`. An example of the correct file name format would be like the file name in the picture below.
...
Add in another suitable title and click `Create pull request`.
